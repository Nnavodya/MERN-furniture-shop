    ...
    >
      ...
      <div
        style={{
          height: 3,
          background:
            "linear-gradient(90deg, transparent, #D4A373, transparent)",
        }}
      />
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Brand */}
          <div>
            <h2 className="text-3xl font-bold mb-4" style={{ color: "#D4A373" }}>
              FurniHub
            </h2>
            ...
            <div className="flex gap-4 mt-6">
              {[TbBrandFacebook, TbBrandInstagram, TbBrandTwitter, TbBrandPinterest].map(
                (Icon, i) => (
                  <a
                    key={i}
                    href="#"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-semibold mb-5" style={{ color: "#D4A373" }}>
              Quick Links
            </h3>
          ...
          <div>
            ...
            {/* Newsletter */}
            <div className="mt-6">
              <p className="mb-3 text-sm" style={{ color: "rgba(255,255,255,0.75)" }}>
                  ...
                  <div className="flex">
                    <input
                      ...
                      style={{
                        ...
                        border: `1px solid ${status === "error" ? "rgba(226,75,74,0.60)" : "rgba(212,163,115,0.25)"}`,
                        borderRight: "none",
                        color: "#FFFFFF",
                      }}
                    />
      ...
      {/* ── Copyright bar ── */}
      <div
        style={{ borderTop: "1px solid rgba(255,255,255,0.10)", background: "#1E0F05" }}
      >
